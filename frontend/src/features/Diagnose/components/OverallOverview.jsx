...
const getHealthStatus = (data, healthScore) => {
  ...
  const issueResolutionRate =
    totalIssues > 0
      ? Math.round(((data.issues?.closed || 0) / totalIssues) * 100)
      : 0;
...
const OverallOverview = ({ projectData }) => {
  ...
  const primaryLanguagePercentage =
    languageData && languageData.length > 0 ? languageData[0].value || 0 : 0;
          ...
          <div>
            ...
            <div className="mb-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <div className="text-xs text-blue-600 mt-1">
                Accounts for {(primaryLanguagePercentage || 0).toFixed(1)}% of
                total
              </div>
            </div>
                ...
                >
                  ...
                  <img
                    src={
                      ...
                      `https://github.com/${contributor.name || contributor.login}.png`
                    }
