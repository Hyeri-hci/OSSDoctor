...
const ActivityLeaderboard = ({ onBack }) => {
  ...
  const { leaderboardData, currentUser, loading, error, refreshData } =
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600">
            See the users who are actively contributing to projects.
          </p>
        </div>
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-sm text-gray-600">
                        PRs: {user.prCount} | Issues: {user.issueCount} |
                ...
                <div className="font-bold text-lg mb-1">
                  {timePeriod === "today"
                    ...
                    : timePeriod === "week"
                      ...
                      : "This Month"}
                  :{" "}
                  {currentUser.periodScore
                    ? currentUser.periodScore.toLocaleString()
                    : currentUser.totalScore?.toLocaleString() || 0}{" "}
                  pts
                </div>
                <div className="text-sm text-gray-600">
                  PRs: {currentUser.prCount || 0} | Issues:{" "}
                  {currentUser.issueCount || 0} | Reviews:{" "}
                  {currentUser.reviewCount || 0}
                  {currentUser.contributionStreak > 0 && (
                    <span className="ml-2 text-orange-600">
                      🔥 {currentUser.contributionStreak} day streak
                    </span>
                  )}
                </div>
                {(currentUser.periodScore === 0 ||
                  (!currentUser.periodScore &&
