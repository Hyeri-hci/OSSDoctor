  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-gray-600 mb-6">
        Check your project contribution history.
      </p>
      ...
      displayData.recentActivities.length > 0 ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-sm text-gray-500 mb-4">
            No contribution history has been registered yet.
            <br />
            Your contributions to projects on GitHub will be displayed here.
          </p>
          <button
            onClick={() => navigate("/ecosystem")}
            className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-blue-700 bg-blue-100 hover:bg-blue-200"
          >
            Find open source projects to upcycle
          </button>
        </div>
      )}
    </div>
