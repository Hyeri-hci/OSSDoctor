...
const BadgesTab = () => {
  ...
  const { filteredBadges, filter, setFilter, earnedCount, totalCount } =
    useBadgeFiltersNew(badges);
  ...
  if (loading) {
    return (
      <LoadingSpinner message="Loading badge data..." size="md" color="blue" />
    );
  }
  ...
  const renderCategorizedBadges = () => {
    return Object.entries(categorizedBadges).map(
          ...
          <div key={category} className="mb-8">
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-600">
                {categoryBadges.filter((badge) => badge.earned).length} /{" "}
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-gray-600">
        View badges earned for your project contributions and activities. Filter
        by category or earned status.
      </p>
