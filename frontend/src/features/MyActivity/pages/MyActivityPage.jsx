...
const MyActivityPage = () => {
  ...
  // User data (data from API + defaults)
  const userData = {
    ...
    description: "Contributing to various open source projects through GitHub.",
    ...
    scores: {
      ...
      activity: Math.min(
        90,
        data.stats?.monthlyPR * 5 +
          data.stats?.monthlyIssue * 3 +
          data.stats?.monthlyCommit * 2 || 0,
      ),
